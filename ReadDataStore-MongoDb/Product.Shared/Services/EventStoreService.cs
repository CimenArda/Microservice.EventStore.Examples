...
namespace Shared.Services
{
    public class EventStoreService : IEventStoreService
    {
        ...
        public Task SubscribeToStreamAsync(string streamName, Func<StreamSubscription, ResolvedEvent, CancellationToken, Task> eventAppeared) => Client.SubscribeToStreamAsync(

            streamName: streamName,
            start: FromStream.Start,
            eventAppeared: eventAppeared,
            subscriptionDropped: (streamSubsciption,subscriptionDroppedReason, exception) => {
